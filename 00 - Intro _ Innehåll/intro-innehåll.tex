...
\begin{figure}[!h]
\centering
\includegraphics[width=\textwidth]{Fysik logga ny.png}
\end{figure}
\vspace{-20pt}
\begin{center}
...
Du har nu nöjet att hålla i din hand 2025 års upplaga av Kongl. Fysiks sångbok!
...
\begin{center}
    \textit{Silas Åkerman, F-23\quad Wilhelm Carmevik, F-22}
\end{center}
\begin{flushright}
    \textit{Sångbokskommittén 2026}
\end{flushright}
...
så som schmeck, handskar, medaljer, och sidenband. Vad gäller handskar bärs den korta 
\newpage
\setlength{\oddsidemargin}{-0.37in}
\noindent
