...
\nysida{14}{1}
\noindent
\huge{Oo Visor till Fysiker}
\begin{center}
\Large o1. Konglig Fysiks Paradhymn \\ 
\mel{Katyuscha}
\end{center}
...
\vspace{5pt}\\
\textit{Under sista versen står F-teknologer, men inga andra.\\ "Quristina" och "o Osquar" kan bytas efter behag.}
\begin{flushright}
\textit{Dum-Dum 1977}
\end{flushright}
...
\noindent
\begin{center}
\Large o2. Årskursernas hederssång \\ 
\end{center}
\vspace{-15pt}
\begin{table}[!h]
...
\noindent
\begin{center}
\Large o3. De Brevitate Vitae (Gaudeamus) \\ 
\end{center}
...
\begin{center}
\Large o6. När Fumla blev fem \\
\mel{När vi två blir en}
\end{center}
\textit{Ettan:} \\
...
\vspace{20pt} 
\begin{center}
\Large o$\infty$. O gamla klang och jubeltid \\ 
