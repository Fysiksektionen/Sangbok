...
\vspace{20pt}
\begin{center}
\songtitle{$\iota25$}{Système Bolaget}
\mel{Studentsången}
\end{center}
\begin{lyrics}
...
Isoterm... (etc.)
\end{lyrics}
\auth{Klas Kristensson och Martin Siklosi, F-21}

\nysida{9}{27}

\begin{center}
    \songtitle{$\iota27$}{Å se funktionen då}
    \mel{The Rattlin' Bog} 
\end{center}
\begin{lyrics}
$\|$: Å se funktionen då \\
