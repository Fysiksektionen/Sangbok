...
att vi må lida pin!
\vspace{5pt}\\
\textit{Stämma 1:} Flaskan och glasen har gått i sin!\\
\textit{Stämma 2:} Hit med vin, mera vin!\\
\textit{Stämma 1:} Tror ni att vi är fyllesvin?\\
\textit{Stämma 2:} JA, fast större! 
\end{lyrics}
